...
st.set_page_config(page_title="究極黑客控制台 v14.5", page_icon="💀", layout="wide")
...
# 2. 部署成功後可進行無限互動的控制台核心 (v14.5)
html_parts = [
    '<!DOCTYPE html>',
    '<html lang="zh-TW">',
    '<head>',
    '    <meta charset="UTF-8">',
    '    <title>Matrix Terminal Command Center v14.5</title>',
    '    <style>',
    ...
    '        ',
    '        /* 震動與紅化 class */',
    '        .nuke-alert-active { background: rgba(30,0,0,1) !important; animation: screen-shake 0.1s infinite !important; }',
    ...
    '        <div class="log-line">💀 遠端深層控制鏈主控台 v14.5 | 侵入成功後將自動解鎖 C2 全功能戰略面板</div>',
    '        <div class="log-line">========================================================================================</div>',
    ...
    '    ',
    '    <div id="c2-dashboard">',
    '        <div class="panel-header">💀 [GHOST-NETWORK CENTRAL C2 PANEL v14.5] - ACCESS GRANTED 💀</div>',
    ...
    '        ',
    '        const chars = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789🧬💀🛰️🔥🔓🚀💥⚡🛸⚙️☣️";',
    '        const alphabet = chars.split("");',
    '        let columns = canvas.width / 16;',
    ...
    '                let p = mouseParticles[i]; ctx.fillStyle = "rgba(0, 255, 0, " + p.alpha + ")";',
    ...
    '        const c2Dashboard = document.getElementById("c2-dashboard");',
    '        const fxLayer = document.getElementById("fullscreen-fx-layer");',
    '        const c2Output = document.getElementById("c2-output");',
    '        ',
    '        let lineCount = 0; let isUnlocked = false; const maxLines = 500;',
    '        function triggerTerminalShake() { terminal.classList.add("shake"); setTimeout(() => { terminal.classList.remove("shake"); }, 400); }',
    '        ',
    ...
    '                const div = document.createElement("div"); div.className = "log-line critical-alert";',
    ...
    '                dynamicContent.appendChild(div); lineCount++;',
    '            }',
    '            const pct = Math.floor((lineCount / maxLines) * 100);',
    ...
    '        }',
    '        ',
    '        document.body.addEventListener("click", () => { if(!isUnlocked) hiddenInput.focus(); });',
    ...
    '                    endMsg.style.color = "#00ff00"; endMsg.style.fontSize = "20px"; endMsg.style.marginTop = "20px"; fontWeight = "bold";',
    ...
    '            const pctText = document.getElementById("sat-pct");',
    ...
    '        }',
    '        ',
    '        /* 3. 💣 自毀程序 -> 回到全黑底 + 紅警強烈閃爍倒數 + 全螢幕縮線崩潰 */',
    '        function triggerNuke() {',
    '            openFxLayer();',
    '            fxLayer.classList.add("nuke-alert-active");',
    '            ',
    '            const nukeTitle = document.createElement("div"); nukeTitle.className = "nuke-title";',
    '            nukeTitle.textContent = "☣️ [CRITICAL SYSTEM OVERLOAD - HOSTILE NUKE COMMAND] ☣️";',
    '            fxLayer.appendChild(nukeTitle);',
    '            ',
    '            const nukeCount = document.createElement("div"); nukeCount.className = "nuke-countdown";',
