...
# 1. 網頁頁面初始化設定
st.set_page_config(page_title="究極黑客控制台 v10.5", page_icon="💀", layout="wide")
...
# 使用 chr(10) 定義換行符號，徹底解決 Python 三引號字串反斜線轉義報錯問題
NL = chr(10)
...
<body>
    ...
    <script>
        ...
        // 頂部日誌狀態（完全移除任何姓名標記）
        let currentText = "==================================================================" + "{NL}" +
                          "💀 首席網路安全專家：[REDACTED] | 核心作戰控制終端 v10.5" + "{NL}" +
                          "==================================================================" + "{NL}" +
                          ">> CORE STATUS: READY" + "{NL}" +
                          ">> INFILTRATION LEVEL: INITIALIZED" + "{NL}{NL}" +
